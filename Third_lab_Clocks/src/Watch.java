public class Watch implements Interface
{
    ...
    public void actionTime(int _h, int _m)
    {
        hours += _h;
        minutes += _m;
    ...
    {
        System.out.println("Brand: '" + brand + '\'' + " - " + "Price: " + price + " $ | " + "Hours: " + hours + " " + "Minutes: " + minutes + ";");
    }

    @Override
    public String printBiggestPrice() {
